...
% \item \textbf{High-Level Game Overview}\\
...
% add simplifications that have been made for this project (baseline does not consider special hands,...)
...
%this is where we go more in depth with the two different models
...
% - Add a sentence about validation here
...
%rn this is kind of copy and pasted from my last project report, need to modify
...
%mention that 1,4,5 are so large beacuse of unseen states
%indsight, probably 
...
%two tables
%1) Max's data and random/mid/initial policy comparison
%2) Marta's data and random/mid/initial policy comparison
%add human in-the loop for each table
